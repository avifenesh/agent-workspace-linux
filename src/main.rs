    ...
    match command {
        ...
        unknown => {
            bail!(
                ...
                "start, open-profile, list, cleanup, status, launch, run, launch-profile-apps, windows, wait-window, screenshot, focus-window, close-window, click, click-window, key, type, logs, wait-app, events, setup, kill-app, stop"
            )
        }
    }
}
