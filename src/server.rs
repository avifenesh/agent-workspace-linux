...
impl AgentWorkspaceLinux {
    ...
    #[tool(
        ...
        description = "List windows inside an isolated agent workspace. By default this returns visible windows; set include_hidden=true to include minimized/hidden windows with visibility metadata.",
        annotations(
            read_only_hint = true,
            destructive_hint = false,
            idempotent_hint = true,
