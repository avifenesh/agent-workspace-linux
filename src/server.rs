...
impl AgentWorkspaceLinux {
    ...
    #[tool(
        ...
        description = "List windows inside an isolated agent workspace, optionally filtering by title/pid/app. By default this returns visible windows; set include_hidden=true to include minimized/hidden windows with visibility metadata.",
        annotations(
            read_only_hint = true,
            destructive_hint = false,
            idempotent_hint = true,
    ...
    #[tool(
        ...
        description = "Show/map a minimized workspace window by X11 window id.",
        annotations(
            read_only_hint = false,
            destructive_hint = false,
            idempotent_hint = false,
