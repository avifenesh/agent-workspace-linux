...
impl AgentWorkspaceLinux {
    ...
    #[tool(
        ...
        description = "Return a read-only inventory of files left in a workspace runtime directory, including manifest, event log, daemon logs, app logs, and screenshots when present.",
        annotations(
            read_only_hint = true,
            destructive_hint = false,
            idempotent_hint = true,
